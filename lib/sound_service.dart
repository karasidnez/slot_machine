...
class SoundService {
  ...
  static Future<void> playWin() => _playSound('win.png');
  static Future<void> playJackpot() => _playSound('win.png');
  static Future<void> playLose() => _playSound('win.png', volume: 0.7);
  static Future<void> playClick() => _playSound('win.png', volume: 0.6);
  ...
  static Future<void> dispoce() async {
